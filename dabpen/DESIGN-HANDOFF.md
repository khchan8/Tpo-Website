# d33843d6-6d0e-4911-a5b3-9150ce5dd49a implementation handoff

This archive is the source of truth for turning the design into production code. Start from `dabpen-manual.html`, then preserve the visual system, responsive behavior, and interactions found in the exported files.
...
- A single self-contained `dabpen-manual.html` is acceptable only when the export truly contains one user-facing screen and its CSS/JS are structured enough to extract tokens, components, states, and behavior.
...
1. Open `dabpen-manual.html` and `DESIGN-MANIFEST.json`; identify every screen file, launcher/overview file, app module, and interaction before coding.
...
- `mqzd1cwp-Dabpen-01.jpg`
- `mqzd1cwz-Dabpen-01.txt`
- `mqzd1cwz-Dabpen-03.jpg`
- `mqzd1cx3-Dabpen-03-04-05.txt`
- `mqzd1cx4-Dabpen-04.jpg`
- `mqzd1cxa-Dabpen-05.jpg`
- `mqzd1cxl-Dabpen-06.jpg`
- `mqzd1cxn-Dabpen-06-07-08.txt`
- `mqzd1cxo-Dabpen-07.jpg`
- `mqzd1cxq-Dabpen-08.jpg`
- `mqzd1cxy-Dabpen-09.jpg`
- `mqzd1cy8-Dabpen-09-10-11.txt`

## Coding checklist for AI tools
1. Inspect `dabpen-manual.html` and `DESIGN-MANIFEST.json` first and identify reusable components before coding.
